...
/// @nodoc
class _$MovieDetailModelTearOff {
  const _$MovieDetailModelTearOff();

  _MovieDetailModel call(
      {required int? id,
...
/// @nodoc
const $MovieDetailModel = _$MovieDetailModelTearOff();
...
/// @nodoc
abstract class _$MovieDetailModelCopyWith<$Res>
    implements $MovieDetailModelCopyWith<$Res> {
  factory _$MovieDetailModelCopyWith(
          _MovieDetailModel value, $Res Function(_MovieDetailModel) then) =
      __$MovieDetailModelCopyWithImpl<$Res>;
  @override
  $Res call(
      {int? id,
      String posterPath,
...
class __$MovieDetailModelCopyWithImpl<$Res>
  ...
  __$MovieDetailModelCopyWithImpl(
      _MovieDetailModel _value, $Res Function(_MovieDetailModel) _then)
      : super(_value, (v) => _then(v as _MovieDetailModel));

  @override
  _MovieDetailModel get _value => super._value as _MovieDetailModel;
...
class _$_MovieDetailModel extends _MovieDetailModel {
  ...
  @override
  String toString() {
    return 'MovieDetailModel(id: $id, posterPath: $posterPath, title: $title, vote: $vote, genres: $genres, duration: $duration, videoPath: $videoPath, rating: $rating, language: $language, description: $description, casts: $casts)';
  }
...
abstract class _MovieDetailModel extends MovieDetailModel {
  const factory _MovieDetailModel(
      ...
      required String language,
      required String description,
      required List<CastModel> casts}) = _$_MovieDetailModel;
