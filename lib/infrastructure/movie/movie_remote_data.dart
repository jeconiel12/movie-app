...
class MovieRemote implements IMovieRemote {
  final _baseUrl = TMDBUrlConfig.baseUrl;
  final _apiKey = TMDBUrlConfig.apiKey;
  @override
  ...
  Future<MovieDetailModel> getMovieDetail(int id) async {
    final url = Uri.parse(
        '$_baseUrl/movie/$id?api_key=$_apiKey&append_to_response=videos,credits,release_dates');
    final response = await http.get(url);
    final data = json.decode(response.body);
